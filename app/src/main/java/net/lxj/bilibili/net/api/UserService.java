...
import net.lxj.bilibili.entity.user.UserCoinsInfo;
import net.lxj.bilibili.entity.user.UserContributeInfo;
import net.lxj.bilibili.entity.user.UserPlayGameInfo;
