package net.lxj.bilibili.net.api;


import net.lxj.bilibili.entity.recommend.RecommendBannerInfo;
import net.lxj.bilibili.entity.recommend.RecommendInfo;
import net.lxj.bilibili.entity.region.RegionDetailsInfo;
import net.lxj.bilibili.entity.region.RegionRecommendInfo;
import net.lxj.bilibili.entity.search.SearchArchiveInfo;
import net.lxj.bilibili.entity.search.SearchBangumiInfo;
import net.lxj.bilibili.entity.search.SearchMovieInfo;
import net.lxj.bilibili.entity.search.SearchSpInfo;
import net.lxj.bilibili.entity.search.SearchUpperInfo;
import net.lxj.bilibili.entity.video.VideoDetailsInfo;
