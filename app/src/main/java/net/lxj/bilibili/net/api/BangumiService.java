...
import net.lxj.bilibili.entity.bangumi.BangumiAppIndexInfo;
import net.lxj.bilibili.entity.bangumi.BangumiDetailsInfo;
import net.lxj.bilibili.entity.bangumi.BangumiDetailsRecommendInfo;
import net.lxj.bilibili.entity.bangumi.BangumiIndexInfo;
import net.lxj.bilibili.entity.bangumi.BangumiRecommendInfo;
import net.lxj.bilibili.entity.bangumi.BangumiScheduleInfo;
import net.lxj.bilibili.entity.bangumi.SeasonNewBangumiInfo;
